...
export type AppTabType = 'students' | 'teachers';
          ...
          <div className="flex items-center space-x-2 sm:space-x-3">
            ...
            {onOpenDatabaseModal && (
              <button
                ...
                className={`inline-flex items-center space-x-1.5 px-3 py-1.5 text-xs sm:text-sm font-bold rounded-xl border transition-all cursor-pointer ${
                  databaseMeta
              ...
              >
                ...
                <span className="hidden sm:inline">Database Sheets</span>
                {databaseMeta ? (
                  <span className="w-2 h-2 rounded-full bg-emerald-500 animate-pulse ml-0.5" title="Database Terhubung" />
                ) : (
                  <span className="text-[10px] text-amber-700 bg-amber-100 px-1.5 py-0.2 rounded font-semibold hidden md:inline">
                    Hubungkan
                  </span>
                )}
              </button>
